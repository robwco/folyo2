...
class OfferingsControllerTest < ActionController::TestCase
  ...
  test "should create offering" do
    assert_difference('Offering.count') do
      post :create, offering: { category: @offering.category, contact_info: @offering.contact_info, description: @offering.description, email: @offering.email, name: @offering.name, title: @offering.title }
    end
  ...
  test "should update offering" do
    patch :update, id: @offering, offering: { category: @offering.category, contact_info: @offering.contact_info, description: @offering.description, email: @offering.email, name: @offering.name, title: @offering.title }
    assert_redirected_to offering_path(assigns(:offering))
  end
